...
public:
	...
	void plan_path(nlohmann::basic_json<> &sensor_fusion, double &car_s, double &car_d, int &previous_path_x_size, int &lane, double &slow_down_to);
	...
	int cost_of_COLLISION(nlohmann::basic_json<> &sensor_fusion, double &car_s, int &previous_path_x_size, int lane);
